...
valid_email = 'testerqap@yandex.ru'  # Ввести валидный email
valid_password = '12345678Yy'  # Ввести валидный пароль
valid_email_reg = 'testerqap@yandex.ru'  # Ввести валидный email
